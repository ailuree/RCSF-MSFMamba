...
train_loader,test_loader,trntst_loader,all_loader,train_num,val_num,trntst_num=get_loader(dataset=opt.dataset, 
        batchsize=opt.batchsize,num_workers=opt.num_work,useval=opt.useval, pin_memory=True, eval_split=opt.eval_split)
...
def train(train_loader, model, optimizer, epoch, save_path):
    ...
    actual_iteration = i
    loss_avg = loss_all / actual_iteration
    acc_avg = acc / num
